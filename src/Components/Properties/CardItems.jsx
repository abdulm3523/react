export default function Card({CardsDate}) {
    return (
        <>
         {
            CardsDate.map((items, index) => (
                <div key={index} className="p-4 bg-white rounded-lg border border-gray-600/10">
                    <img
                        src={items.img}
                        alt="property"/>

                    <div className="p-6">
                        <h4 class="text-2xl font-bold cursor-pointer">{items.title}</h4>
                        <div className="mt-2">
                            <span className="text-xl font-extrabold text-blue-600">{items.cost}</span> /M
                        </div>
                    ...
                    <div className="flex justify-between p-4 text-gray-700 border-t border-gray-300">
                        ...
                        <svg className="w-6 h-6 mr-3 text-gray-600 fill-current" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <p><span className="font-bold text-gray-900">{items.bedrooms}</span> Bedrooms</p>
                        </div>
                        <div className="flex items-center">
                        <svg className="w-6 h-6 mr-3 text-gray-600 fill-current" xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 24 24">
                        ...
                        <p><span className="font-bold text-gray-900">{items.bathrooms}</span> Bathrooms</p>
                        </div>
                    </div>
                    </div>   
            ))
